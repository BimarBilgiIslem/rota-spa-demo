...
define(["require", "exports"], function (require, exports) {
    ...
    function crudButtonsDirective() {
        var directive = {
            restrict: 'E',
            replace: true,
            template: '<div class="rt-crudbutton" ng-if="vm.isNew || !vm.crudPageOptions.readOnly" rt-sticky="{{::vm.crudPageOptions.enableStickyCrudButtons}}">' +
                '<div class="btn-group">' +
    ...
    exports.crudButtonsDirective = crudButtonsDirective;
    //#endregion
    //#region Register
