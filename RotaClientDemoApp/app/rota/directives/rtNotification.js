...
define(["require", "exports"], function (require, exports) {
    ...
    //#endregion
    //#region Directive
    function notificationDirective($filter, logger) {
        var directive = {
            restrict: 'AE',
            scope: {
                notificationLayout: '='
            ...
            link: function (scope, elem, attr) {
                ...
                switch (attr.notificationLayout) {
                    case "content":
                        notificationLayout = 0 /* Content */;
                        break;
                    case "top":
                        notificationLayout = 1 /* Top */;
                        break;
                    case "modal":
                        notificationLayout = 2 /* Modal */;
                        break;
                    default:
                }
                ...
                scope.$watchCollection(function () { return logger.notification.notifications; }, function (notifications) {
                    scope.notifications = $filter("filter")(notifications, { notificationLayout: notificationLayout || 0 /* Content */ });
                });
            }
        };
        return directive;
    ...
    angular.module('rota.directives.rtnotification', [])
        ...
        '$templateCache', function ($templateCache) {
            $templateCache.put('rota/rtNotification-content.tpl.html', '<div>' +
            ...
            $templateCache.put('rota/rtNotification-top.tpl.html', '<div class="rt-notifications"><div class="notifications-container" ng-if="notifications.length" >' +
