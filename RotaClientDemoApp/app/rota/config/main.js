...
//#region Vars
//storage keys consts
var storageNameAuthToken = window.__constants.STORAGE_NAME_AUTH_TOKEN;
var storageNameRoleId = window.__constants.STORAGE_NAME_ROLE_ID;
var storageNameCompanyId = window.__constants.STORAGE_NAME_COMPANY_ID;
//header consts
var headerNameCurrentRoleId = window.__constants.HEADER_NAME_ROLE_ID;
var headerNameCurrentCompanyId = window.__constants.HEADER_NAME_COMPANY_ID;
var headerNameLanguage = window.__constants.HEADER_NAME_LANGUAGE;
//current language 
var currentLanguage = localStorage.getItem(window.__constants.ACTIVE_LANG_STORAGE_NAME) || window.__constants.DEFAULT_LANGUAGE;
//debugging indicator
var debugging = window.__globalEnvironment.debugging;
//#endregion
...
if (window) {
        ...
        config: {
            ...
            text: {
                ...
                onXhr: function (xhr, url) {
                    //set current role id
                    var currentRoleId = sessionStorage.getItem(storageNameRoleId);
                    xhr.setRequestHeader(headerNameCurrentRoleId, currentRoleId);
                    //set current company id
                    var currentCompanyId = sessionStorage.getItem(storageNameCompanyId);
                    ...
                    var tokenModel = sessionStorage.getItem(storageNameAuthToken) ||
                        localStorage.getItem(storageNameAuthToken);
                    if (tokenModel) {
                        var token = JSON.parse(tokenModel);
    ...
    var xpaths = window.__globalEnvironment.xDomPaths;
    if (xpaths) {
        require.config({
            paths: xpaths
        });
